...
RSpec.describe "Api::V1::Articles::Drafts", type: :request do
  ...
  describe "GET /api/v1/articles/drafts" do
    ...
    context "自分の書いた下書きの記事が存在するとき" do
      let!(:article1) { create(:article, :draft, user: current_user) } # rubocop:disable RSpec/IndexedLet
      let!(:article2) { create(:article, :draft) } # rubocop:disable RSpec/IndexedLet
